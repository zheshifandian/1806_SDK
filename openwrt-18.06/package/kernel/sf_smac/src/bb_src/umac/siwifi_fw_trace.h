...
/**
 * struct siwifi_fw_trace_desc - Trace buffer info as provided by fw in ipc
 *
...
/**
 * struct siwifi_fw_trace_buf - Info for trace buffer in shared memory
 *
 ...
 * (by calling _siwifi_fw_trace_reset())
...
/**
 * struct siwifi_fw_trace_local_buf - Info for a local trace buffer
 *
...
/**
 * struct siwifi_fw_trace - info to handle several reader of the shared buffer
 *
...
/**
 * siwifi_fw_trace_empty() - Check if shared buffer is empty
 *
