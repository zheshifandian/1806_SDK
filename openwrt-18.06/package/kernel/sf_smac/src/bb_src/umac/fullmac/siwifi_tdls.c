                          ...
                          u16 prot_mode)
{
    ...
    *pos++ = sizeof(struct ieee80211_vht_operation);
    ...
    case NL80211_CHAN_WIDTH_80:
        ...
        CCFS0(vht_oper) =
                ieee80211_frequency_to_channel(siwifi_vif->sta.ap->center_freq); // Channel Center Frequency Segment 0
    ...
    case NL80211_CHAN_WIDTH_80P80:
        ...
        CCFS0(vht_oper) =
                ieee80211_frequency_to_channel(siwifi_vif->sta.ap->center_freq1); // Channel Center Frequency Segment 0
        CCFS1(vht_oper) =
                ieee80211_frequency_to_channel(siwifi_vif->sta.ap->center_freq2); // Channel Center Frequency Segment 1
        break;
    default:
                              ...
                              const u8 *extra_ies, size_t extra_ies_len)
{
    ...
    if (/*local->hw.queues >= IEEE80211_NUM_ACS &&*/
        ...
        siwifi_add_wmm_info_ie(skb, 0); /* no U-APSD */
                         ...
                         struct cfg80211_chan_def *chandef)
{
    ...
    skb = netdev_alloc_skb(siwifi_vif->ndev,
              ...
              (2 + siwifi_band_2GHz->n_channels + siwifi_band_5GHz->n_channels) + /* supported channels */
