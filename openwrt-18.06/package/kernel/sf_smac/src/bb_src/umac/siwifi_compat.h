...
//#define siwifi_cfg80211_add_iface(wiphy, name, name_assign_type, type, params) siwifi_cfg80211_add_iface(wiphy, name, type, u32 *flags, params)
//#else
//#define siwifi_cfg80211_add_iface(wiphy, name, name_assign_type, type, params) siwifi_cfg80211_add_iface(wiphy, name, name_assign_type, type, u32 *flags, params)
//#endif

//#define siwifi_cfg80211_change_iface(wiphy, dev, type, params) siwifi_cfg80211_change_iface(wiphy, dev, type, u32 *flags, params)

#define CCFS0(vht) vht->center_freq_seg1_idx
#define CCFS1(vht) vht->center_freq_seg2_idx

//#define nla_parse(tb, maxtype, head, len, policy, extack) nla_parse(tb, maxtype, head, len, policy)
...
//#if MY_LINUX_VERSION_CODE < KERNEL_VERSION(4, 11, 0)
//#define cfg80211_cqm_rssi_notify(dev, event, level, gfp) cfg80211_cqm_rssi_notify(dev, event, gfp)
//#endif

//#if MY_LINUX_VERSION_CODE < KERNEL_VERSION(4, 9, 0)
//#define ieee80211_amsdu_to_8023s(skb, list, addr, iftype, extra_headroom, check_da, check_sa) ieee80211_amsdu_to_8023s(skb, list, addr, iftype, extra_headroom, false)
//#endif

//#if MY_LINUX_VERSION_CODE  < KERNEL_VERSION(4, 7, 0)
...
/* MAC80211 */
//#if MY_LINUX_VERSION_CODE < KERNEL_VERSION(4, 18, 0)
//#define siwifi_ops_mgd_prepare_tx(hw, vif, duration) siwifi_ops_mgd_prepare_tx(hw, vif)
//#endif
...
//#if MY_LINUX_VERSION_CODE < KERNEL_VERSION(4, 11, 0)
//#define ieee80211_cqm_rssi_notify(vif, event, level, gfp) ieee80211_cqm_rssi_notify(vif, event, gfp)
//#endif
...
#endif
#endif
#endif /* CONFIG_VENDOR_SIWIFI_AMSDUS_TX */
...
//#if (MY_LINUX_VERSION_CODE < KERNEL_VERSION(4, 16, 0)) && !(defined CONFIG_VENDOR_SIWIFI)
