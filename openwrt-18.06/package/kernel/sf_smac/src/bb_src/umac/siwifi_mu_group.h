...
/**
 * struct siwifi_sta_group_info - Group Information for a STA
 *
...
/**
 * struct siwifi_mu_info - Information about all MU group
 *
 ...
 *                (cf siwifi_sta_group_info.last_update)
 ...
 *                     (ref @siwifi_mu_group_sta_select)
...
#define SIWIFI_MU_GROUP_INTERVAL 200 /* in ms */
#define SIWIFI_MU_GROUP_SELECT_INTERVAL 100 /* in ms */
// minimum traffic in a SIWIFI_MU_GROUP_SELECT_INTERVAL to consider the sta
#define SIWIFI_MU_GROUP_MIN_TRAFFIC 50 /* in number of packet */
