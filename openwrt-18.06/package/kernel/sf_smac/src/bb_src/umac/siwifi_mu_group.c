...
/**
 * siwifi_mu_group_sta_init - Initialize group information for a STA
 *
...
/**
 * siwifi_mu_group_sta_del - Remove a sta from all MU group
 *
...
/**
 * siwifi_mu_group_sta_get_map - Get the list of group a STA belongs to
 *
...
/**
 * siwifi_mu_group_sta_get_pos - Get sta position in a group
 *
 * @siwifi_hw: main driver data
 * @sta: pointer to the sta
 * @group_id: Group id
...
/**
 * siwifi_mu_group_move_head - Move (or add) one element at the top of a list
 *
 * @list: list pointer
...
/**
 * siwifi_mu_group_remove_users - Remove all the users of a group
 *
...
/**
 * siwifi_mu_group_add_users - Add users to a group
 *
 * @mu: pointer on MU info
...
/**
 * siwifi_mu_group_create_one - create on group with a specific group of user
 *
 * @mu: pointer on MU info
...
/**
 * siwifi_mu_group_create - Create new groups containing one specific sta
 *
 * @mu: pointer on MU info
...
/**
 * siwifi_mu_group_work - process function of the "group_work"
 *
...
/**
 * siwifi_mu_group_init - Initialize MU groups
 *
 * @siwifi_hw: main driver data
 *
...
/**
 * siwifi_mu_set_active_sta - mark a STA as active
 *
 * @siwifi_hw: main driver data
 * @sta: pointer to the sta
...
/**
 * siwifi_mu_set_active_group - mark a MU group as active
 *
 * @siwifi_hw: main driver data
 * @group_id: Group id
 *
...
/**
 * siwifi_mu_group_sta_select - Select the best group for MU stas
 *
 * @siwifi_hw: main driver data
 *
 ...
 * for each group for the previous @SIWIFI_MU_GROUP_SELECT_INTERVAL interval:
