...
//The maximum length actually used is 2(xo) + 364(lb) + 1325(hb) + 83(high table) = 1774
#define WIFI_INFO_SIZE          2046
//Length of calibration table for "V4" version is 2(xo) + (364(lb) + 1325(hb)) * 2(two antennas) = 3380
