...
#define MAX_ETH_POOL_SKB_RAW_SIZE     ( 2048)
#endif
#ifndef CONFIG_SFAX8_HNAT_TEST_TOOL
#ifdef CONFIG_MEMORY_OPTIMIZE
/* On lite memory platform, limit tx/rx queue size to 256*/
#define DMA_TX_RING_SZ  128
#define DMA_RX_RING_SZ  512
#else //CONFIG_MEMORY_OPTIMIZE
#define DMA_TX_RING_SZ  1024
#define DMA_RX_RING_SZ  1024
#endif
#else // CONFIG_SFAX8_HNAT_TEST_TOOL
#define DMA_TX_RING_SZ 2048
#define DMA_RX_RING_SZ 2048
#endif
...
#define GMAC_CONTROL_IFG_MASK           0x000e0000              /* bit [19:17] IFG Mask */
...
#define GMAC_CONTROL_IFG_80             (2 << 17)
...
#define GMAC_GMII_ADDR_CR_124           0x00000014              /* bit [5:2] 0101: A18 CSR clock frequency is 250–300 MHz and the MDC clock is CSR clock/124.*/
#define GMAC_GMII_ADDR_CR_62            0x00000004              /* bit [5:2] 0001: A28 CSR clock frequency is 150 MHz and the MDC clock is CSR clock/62.*/
...
//rxdesc1
#define RXDESC1_DISABLE_IRQ             0x80000000              /* bit [31] DIC: Disable Interrupt on Completion */
...
struct sgmac_priv {
	...
	struct delayed_work hnat_work;
#endif

#if IS_ENABLED(CONFIG_SFAX8_ESWITCH_DRIVER)
	struct platform_device *eswitch_pdev;
	struct sf_eswitch_priv * pesw_priv;
#endif

#ifdef CONFIG_DEBUG_FS
	struct dentry  *gmac_debug;
#endif
#ifdef CONFIG_SF_SKB_POOL
