    ...
    AIR_VLAN_ENTRY_ATTR_T *p_attr)
{
    ...
    AIR_VLAN_ENTRY_ATTR_T vlan_entry_attr = {0};

    AIR_PARAM_CHK((vid < AIR_VLAN_ID_MIN) || (vid > AIR_VLAN_ID_MAX), AIR_E_BAD_PARAMETER);
    ...
    {
        memset(&vlan_entry_attr, 0, sizeof(vlan_entry_attr));
        vlan_entry_attr.valid = 1;
        _air_untagged_vlan_writeEntry(unit, vid, &vlan_entry_attr);
    }
    ...
    const UI16_T    pvid)
{
    ...
    AIR_PARAM_CHK((port >= AIR_MAX_NUM_OF_PORTS), AIR_E_BAD_PARAMETER);
    AIR_PARAM_CHK((pvid < AIR_VLAN_ID_MIN) || (pvid > AIR_VLAN_ID_MAX), AIR_E_BAD_PARAMETER);
    ...
    const UI16_T    stag)
{
    ...
    AIR_PARAM_CHK((vid < AIR_VLAN_ID_MIN) || (vid > AIR_VLAN_ID_MAX), AIR_E_BAD_PARAMETER);
    AIR_PARAM_CHK((stag < AIR_VLAN_ID_MIN) || (stag > AIR_VLAN_ID_MAX), AIR_E_BAD_PARAMETER);
