                                        ...
                                        task_pool &tasks)
{
    ...
    case beerocks_message::ACTION_BML_WIFI_CREDENTIALS_SET_REQUEST: {
        ...
        // Previously, the WiFi configuration corresponding to al mac was modified, but now the public WiFi configuration is modified.
        database.add_bss_info_configuration_new(wifi_credentials);
