...
--input netmask is illegal
ERROR_NO_INPUT_NETMASK_ILLEGAL = 1509
...
ERROR_NO_WDS_SSID_PWD_CHANGE = 1714
ERROR_NO_WDS_SSID_MISS = 1715
-- mac error
...
ERROR_NO_IP_NOT_IN_LAN_SEGMENT = 1736
ERROR_NO_INVALID_MTU = 1737
ERROR_NO_GATEWAY_NOT_IN_WAN_SEGMENT = 1738
ERROR_NO_PPPOE_AUTH_ERROR = 1739
-- ac setting
...
function getErrorMessage(errorCode)
    ...
    errorList[1509] = _("input netmask is illegal")
    ...
    errorList[1714] = _("wds host password changed")
    errorList[1715] = _("wds host ssid missed")
    errorList[1716] = _("wds connect timeout")
    -- mac error
    ...
    errorList[1735] = _("error code 678: pppoe connect timeout")
    errorList[1736] = _("ip is not in the lan segment")
    errorList[1737] = _("Invalid MTU, MTU should between 46 and 9000")
    errorList[1738] = _("gateway is not in WAN segment")
    errorList[1739] = _("error code 691: pppoe username or password error")
    -- ac setting
    ...
    errorList[1748] = _("ac not support")
