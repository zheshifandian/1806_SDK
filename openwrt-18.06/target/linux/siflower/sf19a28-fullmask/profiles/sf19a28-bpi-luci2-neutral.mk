...
define Profile/SF19A28-BPI-LUCI2-NEUTRAL
 NAME:= SF19A28 BPI-LUCI2-NEUTRAL
 PACKAGES:=\
	block-mount fstools badblocks
endef

define Profile/SF19A28-BPI-LUCI2-NEUTRAL/Description
 Support for siflower bpi 8+64 boards v1.0
endef

define Profile/SF19A28-BPI-LUCI2-NEUTRAL/Config
...
$(eval $(call Profile,SF19A28-BPI-LUCI2-NEUTRAL))
