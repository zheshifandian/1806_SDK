...
ifdef PROFILE
	board_info = $(shell echo $(PROFILE) | awk -F "-" '{$$1=""; print $$0}' | tr "A-Z" "a-z" | sed "s/^ //g" | tr " " "_")
	__config_name_list = $(1)/config-$(KERNEL_PATCHVER) $(1)/config-$(KERNEL_PATCHVER)_$(board_info) $(1)/config-default
endif
